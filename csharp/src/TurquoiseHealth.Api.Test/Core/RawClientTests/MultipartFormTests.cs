...
namespace TurquoiseHealth.Api.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static TurquoiseHealth.Api.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new TurquoiseHealth.Api.Core.MultipartFormRequest
        {
