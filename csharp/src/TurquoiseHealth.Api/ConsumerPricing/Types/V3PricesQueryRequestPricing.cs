...
[JsonConverter(typeof(V3PricesQueryRequestPricing.JsonConverter))]
[Serializable]
public record V3PricesQueryRequestPricing
{
    internal V3PricesQueryRequestPricing(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// <summary>
    /// Create an instance of V3PricesQueryRequestPricing with <see cref="V3PricesQueryRequestPricing.Cash"/>.
    /// </summary>
    public V3PricesQueryRequestPricing(V3PricesQueryRequestPricing.Cash value)
    {
        Type = "cash";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of V3PricesQueryRequestPricing with <see cref="V3PricesQueryRequestPricing.Negotiated"/>.
    /// </summary>
    public V3PricesQueryRequestPricing(V3PricesQueryRequestPricing.Negotiated value)
    {
        Type = "negotiated";
        Value = value.Value;
    }
    ...
    public TurquoiseHealth.Api.V3PricingCash AsCash() =>
        IsCash
            ...
            : throw new System.Exception("V3PricesQueryRequestPricing.Type is not 'cash'");
    ...
    public TurquoiseHealth.Api.V3PricingNegotiated AsNegotiated() =>
        IsNegotiated
            ...
            : throw new System.Exception("V3PricesQueryRequestPricing.Type is not 'negotiated'");
    ...
    public static implicit operator V3PricesQueryRequestPricing(
        V3PricesQueryRequestPricing.Cash value
    ) => new(value);

    public static implicit operator V3PricesQueryRequestPricing(
        V3PricesQueryRequestPricing.Negotiated value
    ) => new(value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<V3PricesQueryRequestPricing>
    {
        public override bool CanConvert(System.Type typeToConvert) =>
            typeof(V3PricesQueryRequestPricing).IsAssignableFrom(typeToConvert);

        public override V3PricesQueryRequestPricing Read(
        ...
        )
        {
            ...
            return new V3PricesQueryRequestPricing(discriminator, value);
        }

        public override void Write(
            Utf8JsonWriter writer,
            V3PricesQueryRequestPricing value,
            JsonSerializerOptions options
        )
        {
            JsonNode json =
    ...
    public struct Cash
    {
        ...
        public static implicit operator V3PricesQueryRequestPricing.Cash(
            TurquoiseHealth.Api.V3PricingCash value
        ) => new(value);
    }
    ...
    public struct Negotiated
    {
        ...
        public static implicit operator V3PricesQueryRequestPricing.Negotiated(
            TurquoiseHealth.Api.V3PricingNegotiated value
        ) => new(value);
    }
}
