...
[JsonConverter(typeof(PricesQueryRequestPricing.JsonConverter))]
[Serializable]
public record PricesQueryRequestPricing
{
    internal PricesQueryRequestPricing(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// <summary>
    /// Create an instance of PricesQueryRequestPricing with <see cref="PricesQueryRequestPricing.Cash"/>.
    /// </summary>
    public PricesQueryRequestPricing(PricesQueryRequestPricing.Cash value)
    {
        Type = "cash";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of PricesQueryRequestPricing with <see cref="PricesQueryRequestPricing.Negotiated"/>.
    /// </summary>
    public PricesQueryRequestPricing(PricesQueryRequestPricing.Negotiated value)
    {
        Type = "negotiated";
        Value = value.Value;
    }
    ...
    public TurquoiseHealth.Api.PricingCash AsCash() =>
        IsCash
            ...
            : throw new System.Exception("PricesQueryRequestPricing.Type is not 'cash'");
    ...
    public TurquoiseHealth.Api.PricingNegotiated AsNegotiated() =>
        IsNegotiated
            ...
            : throw new System.Exception("PricesQueryRequestPricing.Type is not 'negotiated'");
    ...
    public static implicit operator PricesQueryRequestPricing(
        PricesQueryRequestPricing.Cash value
    ) => new(value);

    public static implicit operator PricesQueryRequestPricing(
        PricesQueryRequestPricing.Negotiated value
    ) => new(value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<PricesQueryRequestPricing>
    {
        public override bool CanConvert(System.Type typeToConvert) =>
            typeof(PricesQueryRequestPricing).IsAssignableFrom(typeToConvert);

        public override PricesQueryRequestPricing Read(
        ...
        )
        {
            ...
            return new PricesQueryRequestPricing(discriminator, value);
        }

        public override void Write(
            Utf8JsonWriter writer,
            PricesQueryRequestPricing value,
            JsonSerializerOptions options
        )
        {
            JsonNode json =
    ...
    public struct Cash
    {
        ...
        public static implicit operator PricesQueryRequestPricing.Cash(
            TurquoiseHealth.Api.PricingCash value
        ) => new(value);
    }
    ...
    public struct Negotiated
    {
        ...
        public static implicit operator PricesQueryRequestPricing.Negotiated(
            TurquoiseHealth.Api.PricingNegotiated value
        ) => new(value);
    }
}
