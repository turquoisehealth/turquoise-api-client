...
[Serializable]
public record V3ListEnvelopeProviderPackagePrice : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public V3ListEnvelopeProviderPackagePriceObject? Object { get; set; }

    [JsonPropertyName("items")]
    public IEnumerable<V3ProviderPackagePrice> Items { get; set; } =
        new List<V3ProviderPackagePrice>();

    [JsonPropertyName("page")]
    public required V3PageMeta Page { get; set; }
    ...
    public V3NoDataReason? NoDataReason { get; set; }
