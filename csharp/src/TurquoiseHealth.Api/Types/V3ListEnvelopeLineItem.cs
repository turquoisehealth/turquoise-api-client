...
[Serializable]
public record V3ListEnvelopeLineItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public V3ListEnvelopeLineItemObject? Object { get; set; }

    [JsonPropertyName("items")]
    public IEnumerable<V3LineItem> Items { get; set; } = new List<V3LineItem>();
