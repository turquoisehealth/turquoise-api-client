...
[Serializable]
public record V3ListEnvelopePackage : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public V3ListEnvelopePackageObject? Object { get; set; }

    [JsonPropertyName("items")]
    public IEnumerable<V3Package> Items { get; set; } = new List<V3Package>();
