...
[Serializable]
public record ListEnvelopeProviderPackagePrice : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public ListEnvelopeProviderPackagePriceObject? Object { get; set; }

    [JsonPropertyName("items")]
    public IEnumerable<ProviderPackagePrice> Items { get; set; } = new List<ProviderPackagePrice>();
