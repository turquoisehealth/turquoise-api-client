...
[Serializable]
public record ListEnvelopeProvider : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public ListEnvelopeProviderObject? Object { get; set; }

    [JsonPropertyName("items")]
    public IEnumerable<Provider> Items { get; set; } = new List<Provider>();
