...
[Serializable]
public record V3ListEnvelopePayer : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public V3ListEnvelopePayerObject? Object { get; set; }

    [JsonPropertyName("items")]
    public IEnumerable<V3Payer> Items { get; set; } = new List<V3Payer>();
