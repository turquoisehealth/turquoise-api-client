...
[Serializable]
public record ListEnvelopePackage : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public ListEnvelopePackageObject? Object { get; set; }

    [JsonPropertyName("items")]
    public IEnumerable<Package> Items { get; set; } = new List<Package>();
