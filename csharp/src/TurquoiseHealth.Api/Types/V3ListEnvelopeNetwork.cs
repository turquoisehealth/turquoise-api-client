...
[Serializable]
public record V3ListEnvelopeNetwork : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public V3ListEnvelopeNetworkObject? Object { get; set; }

    [JsonPropertyName("items")]
    public IEnumerable<V3Network> Items { get; set; } = new List<V3Network>();
