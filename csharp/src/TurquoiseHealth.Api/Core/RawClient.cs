...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::TurquoiseHealth.Api.Core.ApiResponse> MakeRequestAsync(
        global::TurquoiseHealth.Api.Core.BaseRequest request,
    ...
    internal async global::System.Threading.Tasks.Task<global::TurquoiseHealth.Api.Core.ApiResponse> SendRequestAsync(
        global::TurquoiseHealth.Api.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::TurquoiseHealth.Api.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::TurquoiseHealth.Api.Core.ApiResponse
            {
    ...
    private static string BuildUrl(global::TurquoiseHealth.Api.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use global::TurquoiseHealth.Api.Core.ApiResponse instead.")]
    internal record ApiResponse : global::TurquoiseHealth.Api.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::TurquoiseHealth.Api.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::TurquoiseHealth.Api.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::TurquoiseHealth.Api.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::TurquoiseHealth.Api.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::TurquoiseHealth.Api.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::TurquoiseHealth.Api.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::TurquoiseHealth.Api.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest
        : global::TurquoiseHealth.Api.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::TurquoiseHealth.Api.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::TurquoiseHealth.Api.Core.StreamRequest;
}
