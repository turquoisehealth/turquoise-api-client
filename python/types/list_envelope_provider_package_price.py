...
class ListEnvelopeProviderPackagePrice(UniversalBaseModel):
    object: typing.Optional[ListEnvelopeProviderPackagePriceObject] = None
    items: typing.List[ProviderPackagePrice]
    page: PageMeta
