...
class TurquoiseHealth:
    ...
    def __init__(
        ...
        *,
        ...
        self._consumer_pricing: typing.Optional[ConsumerPricingClient] = None

    @property
    def consumer_pricing(self):
        if self._consumer_pricing is None:
            from .consumer_pricing.client import ConsumerPricingClient  # noqa: E402

            self._consumer_pricing = ConsumerPricingClient(client_wrapper=self._client_wrapper)
        return self._consumer_pricing


class AsyncTurquoiseHealth:
    """
    Use this class to access the different functions within the SDK. You can instantiate any number of clients with different configuration that will propagate to these functions.
    ...
    def __init__(
        ...
        *,
        ...
        self._consumer_pricing: typing.Optional[AsyncConsumerPricingClient] = None

    @property
    def consumer_pricing(self):
        if self._consumer_pricing is None:
            from .consumer_pricing.client import AsyncConsumerPricingClient  # noqa: E402
